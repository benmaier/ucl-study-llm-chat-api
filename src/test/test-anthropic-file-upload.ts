/**
 * Test: Anthropic Claude File Upload and Code Execution
 *
 * Tests uploading a CSV file and asking Claude to plot the data.
 */
...
async function main() {
  ...
  console.log("Test: Anthropic Claude File Upload");
  console.log("=".repeat(60));
  ...
  try {
    ...
    console.log("\n2. Asking Claude to plot the CSV data...");
