/**
 * Test: Google Gemini File Upload and Code Execution
 *
 * Tests uploading a CSV file and asking Gemini to plot the data.
 */
...
async function main() {
  ...
  console.log("Test: Google Gemini File Upload");
  console.log("=".repeat(60));
  ...
  try {
    ...
    console.log("\n2. Asking Gemini to plot the CSV data...");
    ...
    // Step 4: Download generated files (from inline base64)
